...
#ifndef FLATBUFFERS_GENERATED_PDU_H_
#define FLATBUFFERS_GENERATED_PDU_H_
...
enum CellType {
  CellType_CELLTYPE_INT = 0,
  CellType_CELLTYPE_BOOL = 1,
  CellType_CELLTYPE_NAME = 2,
  CellType_CELLTYPE_MESSAGE = 3,
  CellType_MIN = CellType_CELLTYPE_INT,
  CellType_MAX = CellType_CELLTYPE_MESSAGE
};

inline CellType (&EnumValuesCellType())[4] {
  static CellType values[] = {
    CellType_CELLTYPE_INT,
    CellType_CELLTYPE_BOOL,
    CellType_CELLTYPE_NAME,
    CellType_CELLTYPE_MESSAGE
  };
  return values;
}
...
inline flatbuffers::Offset<Cell> CreateCell(
    flatbuffers::FlatBufferBuilder &_fbb,
    CellType type = CellType_CELLTYPE_INT,
    uint32_t intVal = 0,
    bool boolVal = false,
...
#endif  // FLATBUFFERS_GENERATED_PDU_H_
