...
#ifndef FLATBUFFERS_GENERATED_PDU_GTP_H_
#define FLATBUFFERS_GENERATED_PDU_GTP_H_
...
inline flatbuffers::Offset<PDU> CreatePDUDirect(
  ...
  return GTP::CreatePDU(
      _fbb,
      cells ? _fbb.CreateVector<flatbuffers::Offset<Cell>>(*cells) : 0);
}

inline const GTP::PDU *GetPDU(const void *buf) {
  return flatbuffers::GetRoot<GTP::PDU>(buf);
}

inline bool VerifyPDUBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<GTP::PDU>(nullptr);
}

inline void FinishPDUBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<GTP::PDU> root) {
  fbb.Finish(root);
}

}  // namespace GTP

#endif  // FLATBUFFERS_GENERATED_PDU_GTP_H_
