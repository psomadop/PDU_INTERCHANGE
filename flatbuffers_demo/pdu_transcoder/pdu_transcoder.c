        ...
        switch (cur->type)
        {
            ...
            case CELL_TYPE_MESSAGE:
                ...
                GTP_ComplexType_intSequence_add(B,
                        flatbuffers_int32_vec_create(B, cur->u.message.integers, 4));
                // Done with ComplexType creation. Tell builder.
                GTP_ComplexType_ref_t fmsg =  GTP_ComplexType_end(B);
                // And add to Cell.
                GTP_Cell_msg_add(B, fmsg);
                break;
        }
...
int pdu_decode(TX_PDU* tx_pdu, char* buffer, int buffer_size)
{
    ...
    memset(tx_pdu->cells, 0, tx_pdu->num_cells * sizeof(CELL));
    for (i = 0; i < tx_pdu->num_cells; i++)
    {
        CELL *cur = &tx_pdu->cells[i];
        ...
        switch (cur->type)
        {
            ...
            case GTP_CellType_MESSAGE:
                ...
                // Decode integer flatbuffers vector to int array.
                int int_len = flatbuffers_int32_vec_len(fintSeq);
