...
oer_type_decoder_f BitString_decode_oer;
oer_type_encoder_f BitString_encode_oer;
per_type_decoder_f BitString_decode_uper;
per_type_encoder_f BitString_encode_uper;
