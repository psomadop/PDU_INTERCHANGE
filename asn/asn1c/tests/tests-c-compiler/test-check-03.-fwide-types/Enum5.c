 ...
 */
static asn_oer_constraints_t asn_OER_type_Enum5_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_Enum5_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_Enum5 = {
	...
	sizeof(asn_DEF_Enum5_tags_1)
		/sizeof(asn_DEF_Enum5_tags_1[0]), /* 1 */
	{ &asn_OER_type_Enum5_constr_1, &asn_PER_type_Enum5_constr_1, ENUMERATED_constraint },
